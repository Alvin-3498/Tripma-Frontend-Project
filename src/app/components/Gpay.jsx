...
const Gpay = () => {
  return (
    <div>
      ...
      {/* title */}
      <div className='mt-5'>
        <p className={`${nunito.className} text-gray-600 md:text-lg`}>Google pay details</p>
      </div>
      ...
      <div className='flex flex-col gap-5'>
        ...
        <div>
          <input className={`${nunito.className} border-1 w-[270px] h-[35px] border-gray-300 rounded-md outline-none pl-2 text-[14px] md:w-[400px] md:h-[40] md:text-[15px] xl:w-[500px] xl:h-[45px]`} type="text" placeholder='Enter the UPI ID' />
        </div>
      </div>
